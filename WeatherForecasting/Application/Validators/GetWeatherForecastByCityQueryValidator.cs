...
/// <summary>
/// Validator for <see cref="GetWeatherForecastByCityQuery"/> ensuring that the city, country code,
/// and weather provider are valid and meet the required constraints.
/// </summary>
/// <remarks>
