...
public class GetWeatherForecastByLonAndLatQueryValidatorTests
{
    private readonly GetWeatherForecastByLonAndLatQueryValidator _validator = new();

    [Fact]
    public void Should_Pass_Validation_When_All_Fields_Are_Valid()
    {
        var query = new GetWeatherForecastByLonAndLatQuery(
            Longitude: 45.0,
            Latitude: 30.0,
